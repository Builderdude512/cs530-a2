...
SymTable arSymTable[maximum];

void formator1(std::string codename){

}

void formator2(std::string codename, std::int r1, std::int r2) {

}

void formator3(std::string codename, std::int m){
